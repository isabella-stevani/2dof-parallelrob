...
saveas(gcf,['images/discrete/cntr_nomsim_states','.eps'], 'epsc');
saveas(gcf,'images/discrete/cntr_nomsim_states.png');
% 
% Control signal
figure; leg = {'FL'};
xlab = {'','Time [s]'};
...
supertitle(tlab,18);
set(gcf,'PaperPositionMode','auto');
saveas(gcf,['images/discrete/cntr_nomsim_cntrsig','.eps'], 'epsc');
saveas(gcf,'images/discrete/cntr_nomsim_cntrsig.png');
...
supertitle(tlab,18);
set(gcf,'PaperPositionMode','auto');
saveas(gcf,['images/discrete/cntr_nomsim_error','.eps'], 'epsc');
saveas(gcf,'images/discrete/cntr_nomsim_error.png');
...
for i = 1:n
    ...
    %%% Dynamics
    [q,dq,u] = ParallelRobDynamics_d(x0,t,param,uncparam,lambda,ref,... 
        cord,T,sat);
...
set(gcf,'PaperPositionMode','auto');
saveas(gcf,['images/discrete/cntr_uncsim_states','.eps'], 'epsc');
saveas(gcf,'images/discrete/cntr_uncsim_states.png');
...
supertitle(tlab,18);
set(gcf,'PaperPositionMode','auto');
saveas(gcf,['images/discrete/cntr_uncsim_cntrsig','.eps'], 'epsc');
saveas(gcf,'images/discrete/cntr_uncsim_cntrsig.png');
...
supertitle(tlab,18);
set(gcf,'PaperPositionMode','auto');
saveas(gcf,['images/discrete/cntr_uncsim_error','.eps'], 'epsc');
saveas(gcf,'images/discrete/cntr_uncsim_error.png');
